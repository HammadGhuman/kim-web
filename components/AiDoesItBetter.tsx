...
function AiDoesItBetter() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="md:text-2xl mt-2 font-Marsden md:leading-[29.64px] md:text-center lg:w-[1159px]  md:w-auto w-[277px] text-justify text-white font-medium tracking-[-4%] text-lg leading-snug">
