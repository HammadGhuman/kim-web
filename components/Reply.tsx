  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-5 mt-10 bg-white/10 px-10 py-10 mx-10 md:mx-96 rounded-[20px]">
     ...
     <div className="flex flex-col items-center md:items-start justify-center space-y-2 w-full">
        ...
        <input
          type="text"
          className="w-[297px] md:w-full h-[50px] bg-white/10 rounded-[20px] border-blue-400"
        />
      </div>

      <div className="flex flex-col md:items-start items-center justify-center space-y-2 w-full">
     ...
     <div className="flex flex-col items-center md:items-start justify-center space-y-2 w-full">
      ...
      <div className="flex flex-col md:items-start items-center justify-center space-y-2 w-full">
        ...
        <input
          type="text"
          className="w-[297px] md:w-full h-[152px] bg-white/10 rounded-[20px] border-blue-400"
        />
      </div>
