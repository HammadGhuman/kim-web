    ...
    <div className='flex h-[166px] w-[334px] flex-col items-center justify-center space-y-5 rounded-[5px] border border-white bg-blue-400 bg-opacity-10 px-4 md:h-[480px] md:w-auto md:px-24 md:py-10'>
      ...
      <div
        className={`text-center ${
          index === 0 && 'md:text-[32px] md:leading-[40.94px]'
        } ${index === 1 && 'md:text-lg md:leading-[40.94px]'} ${
          index === 2 && 'md:text-[32px] md:leading-[40.94px]'
        } font-['Marsden'] text-[10px] font-normal leading-[19px] tracking-tight text-white md:w-[851px]  md:leading-[49px]`}
      >
        {description}
      </div>
    </div>
