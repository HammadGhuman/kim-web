...
function Kommt({ heading, description }: Props) {
  return (
    <div className='flex h-[166px] w-[334px] flex-col select-none items-center justify-center space-y-5 rounded-[5px] border border-white bg-blue-400 bg-opacity-10 px-4 md:h-[650px] md:w-auto md:px-24 md:py-10'>
