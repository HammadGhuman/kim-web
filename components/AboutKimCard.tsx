...
function AboutKimCard() {
  return (
    <div className='flex w-[1068px] flex-col items-center rounded-[5px] border  border-white bg-blue-400 bg-opacity-20 mt-24'>
      <div className=" mt-8 w-[967px] text-center font-Marsden leading-[50px] text-2xl font-medium text-white">
      ...
      <div className=" pb-8 mt-10 w-[967px] text-center font-Marsden leading-[50px] text-2xl font-medium text-white">
