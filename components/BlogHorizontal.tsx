...
function BlogHorizontal({ title, description, img }: Props) {
  return (
    <div className="bg-[#4b6aa3] bg-opacity-40 flex py-10 px-10 rounded-lg w-full">
      {/* left side */}
      <div className="flex flex-col px-3 py-4">
        ...
        <h1 className="w-[479px] text-white text-2xl font-bold font-['Marsden'] leading-[1.5] mt-4">
          {title}
        </h1>
