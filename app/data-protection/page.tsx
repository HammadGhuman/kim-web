...
function Page() {
  return (
    <div className="flex flex-col items-center justify-center">
      <h1 className="w-[201px] text-center text-white text-[32px] font-semibold font-Marsden leading-[72px]">
        Datenschutz
        <br />
      </h1>
      <h1 className="w-[202px] md:w-auto text-center text-white text-lg md:text-2xl  font-Marsden">
        KI Mentor Technology GmbH Amtsgericht Mannheim HRB 744712
        Geschäftsführer: Christian Krauter
      </h1>

      <div className="w-[241px] md:w-auto  md:px-20">
        <span className="text-white text-xl  font-['Marsden']">
          <br />
          ...
          WIX
          <br />
          Anbieter ist die Wix.com Ltd., 40 Namal Tel Aviv St., Tel Aviv
          6350671, Israel (nachfolgend „WIX“).
          <br />
          WIX ein Tool zum Erstellen und zum Hosten von Webseiten. Wenn Sie
          unsere Website besuchen, werden mit Hilfe von WIX das Nutzerverhalten,
          die Besucherquellen, die Region der Websitebesucher und die
          Besucherzahlen analysiert. WIX speichert Cookies auf Ihrem Browser,
          die für die Darstellung der Website und zur Gewährleistung der
          Sicherheit erforderlich sind (notwendige Cookies).
          <br />
          Die Daten, die über WIX erfasst werden, können auf verschiedenen
          Servern weltweit gespeichert werden. Die Server von WIX stehen u. a.
          in den USA.
          <br />
          Details entnehmen Sie der Datenschutzerklärung von WIX:{" "}
        </span>
        <span className="text-white text-xl  font-['Marsden'] underline">
        ...
        <span className="text-white text-xl  font-['Marsden']">
          ...
          Website ist:
          <br />
          KI Mentor Technology GmbHWachtelstraße 475245 Neulingen
          <br />
          Telefon: +49 176 60415870E-Mail: Christian.Krauter@ki-mentor.com
          <br />
          ...
          Google reCAPTCHA
          <br />
          Unsere Website benutzt Google reCAPTCHA. Um Eingabeformulare auf
          unserer Seite zu schützen, setzen wir „reCAPTCHA“ der Firma Google
          Inc., 1600 Amphitheatre Parkway, Mountain View, CA 94043 USA,
          nachfolgend „Google“, ein. Durch den Einsatz dieses Dienstes kann im
          Rahmen einer Analyse des Verhaltens des Websitebesuches unterschieden
          werden, ob die entsprechende Eingabe menschlicher Herkunft ist oder
          durch automatisierte maschinelle Verarbeitung missbräuchlich erfolgt.
          Zum Zwecke dieser Analyse wertet der Dienst unterschiedliche
          Informationen, z.B. die IP-Adresse, Verweildauer des Besuches auf der
          Website oder verfolgte Mausbewegungen, aus, und leitet diese Daten an
          Google weiter. Google verwendet die so erlangten Informationen unter
          anderem dazu, Bücher und andere Druckerzeugnisse zu digitalisieren
          sowie Dienste wie Google Street View und Google Maps zu optimieren
          (bspw. Hausnummern- und Straßennamenerkennung). Die im Rahmen von
          „reCAPTCHA“ übermittelte IP-Adresse wird nicht mit anderen Daten von
          Google zusammengeführt, außer Sie sind zum Zeitpunkt der Nutzung des
          „reCAPTCHA“-Plug-ins bei Ihrem Google-Account angemeldet. Wenn Sie
          diese Übermittlung und Speicherung von Daten über Sie und Ihr
          Verhalten auf unserer Webseite durch „Google“ unterbinden wollen,
          müssen Sie sich bei „Google“ ausloggen und zwar bevor Sie unsere Seite
          besuchen bzw. das reCAPTCHA Plug-in benutzen. Die Nutzung des Dienstes
        ...
        <span className="text-white text-xl  font-['Marsden']">
          ...
          Einwilligungen bzw. deren Widerruf zuordnen zu können. Die so
          erfassten Daten werden gespeichert, bis Sie uns zur Löschung
        ...
        <span className="text-white text-xl  font-['Marsden']">
          ...
          mit Google registrieren. Anbieter dieses Dienstes ist die Google
        ...
        <span className="text-white text-xl  font-['Marsden']">
          ...
          möglichst einfachen Registrierungsprozess zu ermöglichen (Art. 6 Abs.
          1 lit. f DSGVO). Da die Nutzung der Registrierungsfunktion freiwillig
          ist und die Nutzer selbst über die jeweiligen Zugriffsmöglichkeiten
          ...
          <br />
          Statt einer direkten Registrierung auf dieser Website können Sie sich
          mit Facebook Connect registrieren. Anbieter dieses Dienstes ist die
          ...
          Dadurch wird Ihr Facebook-Profil mit dieser Website bzw. unseren
          Diensten verknüpft. Durch diese Verknüpfung erhalten wir Zugriff auf
        ...
        <span className="text-white text-xl  font-['Marsden']">
          ...
          Instagram
          <br />
          Wir verfügen über ein Profil bei Instagram. Anbieter dieses Dienstes
          ist die Meta Platforms Ireland Limited, 4 Grand Canal Square, Grand
        ...
        <span className="text-white text-xl  font-['Marsden'] underline">
          ...
          Details zu deren Umgang mit Ihren personenbezogenen Daten entnehmen
          Sie der Datenschutzerklärung von LinkedIn:
          https://www.linkedin.com/legal/privacy-policy.-policy
        </span>
        <span className="text-white text-xl  font-['Marsden']">
          .
        </span>
